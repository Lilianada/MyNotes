...
export default function Sidebar({
  ...
  return (
    <>
      <aside 
        id="sidebar"
        className={`fixed top-16 sm:top-0 left-0 z-30 w-64 sm:w-72 md:w-full bg-white dark:bg-gray-800 border-r border-gray-200 transform transition-all duration-300 ease-in-out shadow-lg h-full max-h-[calc(100vh_-_64px)] sm:max-h-[calc(100vh_-_70px)] overflow-y-auto overflow-x-hidden ${
